...
function qtaSearch {
  ...
  $praat --run $script $search $fmin $fmax $smean 0 $shift $order $data_path/qta/data/ $data_path/qta/qta.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/qta/;

  # resynthesis with optimal qta parameters
  $praat --run $script $resynth $fmin $fmax $smean 0 $shift $order $data_path/qta/data/ $data_path/qta/qta.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/qta/;
...
function lrrPredict {
  ...
  $praat --run $script $resynth $fmin $fmax $smean 1 $shift $order $data_path/lrr/data/ $data_path/lrr/lrr.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/lrr/;
...
function krrPredict {
  ...
  $praat --run $script $resynth $fmin $fmax $smean 1 $shift $order $data_path/krr/data/ $data_path/krr/krr.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/krr/;
...
function svrPredict {
  ...
  $praat --run $script $resynth $fmin $fmax $smean 1 $shift $order $data_path/svr/data/ $data_path/svr/svr.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/svr/;
...
function mlpPredict {
  ...
  $praat --run $script $resynth $fmin $fmax $smean 1 $shift $order $data_path/mlp/data/ $data_path/mlp/mlp.target $mmin $mmax $bmin $bmax $lmin $lmax $lambda $store $data_path/mlp/;
