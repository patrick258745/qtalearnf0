...
public:
	...
	void calc_f0 (freq_v& freqResp, const time_v& sampleTimes, const param_s& qtaParams) const;
	void calc_state (state_v& currState, const time_t& currTime, const param_s& qtaParams) const;
...
public:
	...
	void set_sample_times (time_v& sampleTimes) { m_sampleTimes = sampleTimes; };
	void set_orig_f0 (freq_v& origF0) { m_origF0 = origF0; };
	void get_filter_state (state_v& currState, const time_t& currTime, const param_s& qtaParams) const;
